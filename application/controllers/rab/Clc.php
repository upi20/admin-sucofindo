...
class Clc extends Render_Controller
{
    ...
    public function getAktifitasCabang()
    {
        ...
        $exe                     = $this->clc->getAktifitasCabang($id_aktifitas_sub, $id_user);
    ...
    public function getAktifitasCabangKodeIsi1()
    {
        ...
        $exe                     = $this->clc->getAktifitasCabangKodeIsi1($id_aktifitas_cabang);
    ...
    public function getAktifitasCabangKodeIsi2()
    {
        ...
        $exe                     = $this->clc->getAktifitasCabangKodeIsi2($kode_isi_1);
    ...
    public function getAktifitasCabangKodeIsi3()
    {
        ...
        $exe                     = $this->clc->getAktifitasCabangKodeIsi3($kode_isi_2);
    ...
    public function export_excel()
    {
        ...
        $ket = $this->cabangdetail = $this->db->get_where('cabangs', ['id' => $cabang])->row_array();
