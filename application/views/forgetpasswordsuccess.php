      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
            <div class="text-center px-4"><img class="login-intro-img mb-4" src="<?=base_url()?>assets/img/bg-img/38.png" alt="">
              <h3 style="color: black;">Check your mailbox!</h3>
              <p class="mb-4" style="color: black;">We have sent a password recovery email in your email. This email contain 8 digit security code.</p>
              <!-- Go Back Button--><a class="btn btn-primary" href="<?=base_url()?>changepassword" style="background-color: #0036D3;border:none">Change Password</a>
            </div>
          </div>
        </div>
      </div>
