    ...
    <div class="header-area" id="headerArea">
        <div class="container">
            ...
            <div class="header-content position-relative d-flex align-items-center justify-content-between">
                <!-- Back Button-->
                <div class="back-button"><a href="<?= base_url('rab/clc') ?>"><svg width="32" height="32" viewBox="0 0 16 16" class="bi bi-arrow-left-short" fill="currentColor" xmlns="../../www.w3.org/2000/svg.html">
            ...
            <div class="elements-heading mb-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 py-2 px-3 rounded" id="list-breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('rab/clc') ?>">CLC</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Tambah RAB</li>
                    </ol>
                </nav>
            </div>
            <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row  mt-2">
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="number" step="any" name="harga_ringgit" id="harga_ringgit">
                                </div>
                                <div class="col-6">
                                    <label for="harga_rupiah" class="form-label">harga (Rp)</label>
                                    <input class="form-control" type="number" step="any" name="harga_rupiah" id="harga_rupiah">
                                </div>
                            </div>
                            <hr>
                        </div>
                        <div class="form-group" style="margin-left: 12px;">
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="number" name="jumlah_1" id="jumlah_1">
                                </div>
                                <div class="col-6">
                        ...
                        <div class="form-group" style="margin-left: 24px;">
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="number" name="jumlah_2" id="jumlah_2">
                                </div>
                                <div class="col-6">
                        ...
                        <div class="form-group" style="margin-left: 36px;">
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="number" name="jumlah_3" id="jumlah_3">
                                </div>
                                <div class="col-6">
                        ...
                        <div class="form-group" style="margin-left: 48px;">
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="number" name="jumlah_4" id="jumlah_4">
                                </div>
                                <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row mt-2">
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="text" name="total_harga_ringgit" id="total_harga_ringgit">
                                </div>
                                <div class="col-6">
                                    <label for="total_harga_rupiah" class="form-label">Jumlah (Rp)</label>
                                    <input class="form-control" type="text" name="total_harga_rupiah" id="total_harga_rupiah">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
