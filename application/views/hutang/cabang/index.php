...
<body>
    ...
    <div class="page-content-wrapper py-3 elements-page">
        <div class="container">
            <div class="d-flex  justify-content-between w-100">
                <button class="btn btn-creative btn-success my-2" onclick="$('#modalTambah').modal('toggle')"><i class="fa fa-plus" aria-hidden="true"></i> Tambah </button>
                <button class="btn btn-creative btn-secondary my-2" id="bayar-hutang"><i class="fa fa-download" aria-hidden="true"></i> Bayar Utang </button>
            </div>
                ...
                <div class="modal-body">
                    <form action="#" method="POST" id="formTambah">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="id_cabang" name="id_cabang" value="<?= $id_cabang ?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="keterangan" name="keterangan" required rows="3"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="jumlah">Jumlah (RM)</label>
                            <input type="text" class="form-control" id="jumlah" name="jumlah" placeholder="Masukan jumlah sesuai minus saldo / pinjaman" required>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-dialog modal-fullscreen-md-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#" method="POST" id="formDetail">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="detail-id_cabang" name="id_cabang" value="<?= $id_cabang ?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="detail-keterangan" name="keterangan" required rows="3"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="detail-jumlah">Jumlah (RM)</label>
                            <input type="text" class="form-control" id="detail-jumlah" name="jumlah" placeholder="Masukan jumlah sesuai minus saldo / pinjaman" required>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-sm btn-success" type="submit" form="formDetail" id="detail-btn-submit">Ubah</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- modal bayar utang -->
    <div class="modal fade" id="modalBayarUtang" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalBayarUtangLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-sm btn-secondary" type="button" data-bs-dismiss="modal">Close</button>
                    <button class="btn btn-sm btn-success" type="submit" form="form-bayar-hutang">Import</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?= base_url() ?>assets/page/hutang/cabang/index.js"></script>
</body>
